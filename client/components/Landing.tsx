...
const Landing = () => {
    return (
        <div className="relative overflow-hidden bg-white flex items-center px-40">
            <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
                <div className="relative mx auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    <div className="sm:max-w-lg">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl font-serif animate-fade-in-y">Llegó la nueva colección</h1>
                        <p className="mt-4 text-xl text-gray-500 animate-fade-in-y">No dejes para mañana lo que podés comprar hoy!</p>
                    </div>
                    <div>
                        <div className="mt-10">
                                ...
                                <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                                    <div className="flex items-center space-x-6 lg:space-x-8">
                                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                            <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100 animate-fade-up-x">
                                            ...
                                            <div className="h-64 w-44 overflow-hidden rounded-lg animate-fade-up-x">
                                        ...
                                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gp-y-8 animate-fade-up-x">
                                        ...
                                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8 animate-fade-up-x ">
                                            <div className="h-64 w-44 overflow-hidden rounded-lg">
                            ...
                            <a href="/products" className="animate-fade-in-y transition ease-in duration-500 inline-block rounded-md border border-transparent bg-blue-600 px-8 py-3 text-center font-medium text-white hover:bg-blue-300">
                                Ver catálogo
                            </a>
