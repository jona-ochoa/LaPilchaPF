...
const Landing = () => {
    return (
        <div className="relative overflow-hidden flex items-center px-40">
            <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
                <div className="relative mx auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    <div className="sm:max-w-lg">
                        <h1 className="text-4xl font-bold tracking-tight sm:text-6xl font-serif animate-fade-in-y">Llegó la nueva colección</h1>
                        <p className="mt-4 text-xl  animate-fade-in-y">No dejes para mañana lo que podés comprar hoy!</p>
                    </div>
                    <div>
                        <div className="mt-10">
